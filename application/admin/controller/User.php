...
class User extends Base {
    ...
    public function AssessmentOfChannels()
    {
        if(file_exists(APP_PATH.'common/logic/DistributLogicSY.php')){
            ...
            $distributLogic->AssessmentOfChannels();
        }
											...
											if($user_1){
												...
												//if($res && $res['status'] ==1 && !empty($sender)){
													//if ($sender != '15314170988') {  
														...
														$params = array('user_name'=>$user['nickname'] ,'sms_sign'=>'鸿福堂','duoshaoyongjin'=>$zongtjryj  );
												...
												if($user_2){
													...
													//if($res && $res['status'] ==1 && !empty($sender)){
														//if ($sender != '15314170988') {  
															...
															$params = array('user_name'=>$user['nickname'] ,'sms_sign'=>'鸿福堂','duoshaoyongjin'=>$zongssjyj  );
												...
												if($user_3){
													...
													//if($res && $res['status'] ==1 && !empty($sender)){
														//if ($sender != '15314170988') {  
															...
															$params = array('user_name'=>$user['nickname'] ,'sms_sign'=>'鸿福堂','duoshaoyongjin'=>$zongsssjyj  );
